...
class RoadAdmin(admin.ModelAdmin):
    ...
    list_display = ('name_chs', 'history_of_name', 'place_name', 'place_name2', 'related_place', 'update_time', 'create_time', '_id' )
...
class ArchitectureAdmin(admin.ModelAdmin):
    readonly_fields = ('name_chs', 'name_cht', 'name_en', 'des', 'road', 'road_name_chs', 'road_lib_uri',\
        'address', 'house_number', 'longitude', 'latitude', 'longitude_bmap', 'latitude_bmap', 'is_from_lib',\
        'protect_type', 'lib_uri', 'place_name', 'place_uri', 'batch_no', 'first_image_uri', 'first_image_lib_uri',\
        'lib_is_red', 'lib_update_time', 'update_time', 'create_time',)
    list_display = ('name_chs', 'road_name_chs', 'place_name', 'lib_update_time', 'update_time', 'create_time', )
