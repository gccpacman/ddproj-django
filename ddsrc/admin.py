...
class RoadAdmin(admin.ModelAdmin):
    readonly_fields = ('name_chs', 'name_en', 'des', 'lib_uri', 'temporal_value', 'name_after', 'history_of_name', 'history_of_lib_uri', 'place_name', 'place_uri', 'is_from_lib', 'lib_update_time', 'update_time', 'create_time',)
...
class ArchitectureAdmin(admin.ModelAdmin):
    readonly_fields = ('name_chs', 'name_cht', 'name_en', 'des', 'road', 'road_name_chs', 'road_lib_uri', 'address', 'house_number', 'longitude', 'latitude', 'is_from_lib', 'protect_type', 'lib_uri', 'place_name', 'place_uri', 'batch_no', 'first_image_uri', 'first_image_lib_uri', 'lib_is_red', 'lib_update_time', 'update_time', 'create_time',)
    list_display = ('name_chs', 'lib_uri', 'place_name', 'lib_update_time', 'update_time', 'create_time', )
