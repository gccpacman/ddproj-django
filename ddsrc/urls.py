...
urlpatterns = [
    ...
    url(r'^keyword/architecture$',
        ArchitectureFilterView.as_view(),
        name="keyword-architecture"),
    url(r'^road/polylines/$',
        RoadPolylinesView.as_view(),
        name="road-polylines"),
    url(r'^road/relatedplaces/$',
        RoadRelatedPlacesView.as_view(),
        name="road-relatedplaces"),
    url(r'^architecture/positions/$',
        ArchitecturePositionsView.as_view(),
        name="architecture-positons"),
    url(r'^place/relatedprovinces/$',
        PlaceRelatedProvincesCount.as_view(),
        name="place-releated-provinces"),
]
