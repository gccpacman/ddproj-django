...
class Road(models.Model):
    ...
    place_name2 = models.CharField(max_length=64, verbose_name="所在区(手动编辑)", null=True)
    related_place = models.CharField(max_length=128, verbose_name="关联地名", null=True)
    related_place_province = models.CharField(max_length=64, verbose_name="关联地省份", null=True)
